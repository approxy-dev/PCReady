// Site content shared across routes: FAQ and live queue mockup.
// The app catalog + built-in profiles live in ./catalog (auto-generated from the
// app repo's app_catalog.json — run `node scripts/generate-catalog.mjs` to refresh).

export type AppState = "Installed" | "Available" | "Pending";

export type QueueItem = {
  name: string;
  status: "Installed" | "Installing" | "Downloading" | "Queued";
  progress: number;
};
...
export const queueItems: QueueItem[] = [
  { name: "7-Zip", status: "Installed", progress: 100 },
  { name: "Git", status: "Installed", progress: 100 },
  { name: "Visual Studio Code", status: "Installing", progress: 72 },
  { name: "Google Chrome", status: "Downloading", progress: 41 },
  { name: "VLC media player", status: "Queued", progress: 0 },
];
